...
Complete reference for all Zod validation schemas and TypeScript types available in @sw/trpcclient.
...
import { AlbumSchema } from "@sw/trpcclient/schemas";
```
...
```typescript
import { AlbumSchema, type AlbumType } from '@sw/trpcclient';
...
```typescript
import { ArtistSchema, type ArtistType } from '@sw/trpcclient';
...
```typescript
import { CharacterSchema, type CharacterType } from '@sw/trpcclient';
...
```typescript
import { CollectionSchema, type CollectionType } from '@sw/trpcclient';
...
```typescript
import { AllAlbumsSchema } from '@sw/trpcclient';
...
```typescript
import { AlbumSchema, CharacterSchema } from '@sw/trpcclient';
...
```typescript
import { AlbumSchema } from '@sw/trpcclient';
...
import type { AlbumType, CharacterType } from '@sw/trpcclient';
